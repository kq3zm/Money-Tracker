...
public class AddItem extends AppCompatActivity {
    ...
    public void saveEntry (View view) {
        ...
        if ((entryName.equals("")) || (entryCategory.equals("")) || (entryDollar.equals("")) || (entryDetail.equals(""))) {
            ...
            //Get database in read-mode to determine rowIndex
            ...
            db.insert("item", null, initialValues);

            //Move forward to the Main Activity
            Toast.makeText(this, "New item saved!", Toast.LENGTH_SHORT).show();
            i.putExtra("Source", "AddItemActivity Success");
        }
